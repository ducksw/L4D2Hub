...
function selectProfile() {
  ...
  let ret = `
    <span class="text-light">¿Que jugador eres?</span>
    <select id="select" class="form-select w-75 mx-auto mt-2" aria-label="Default select example">
          ...
          resProfile.innerHTML = `
            <div class="d-flex justify-content-center align-items-center w-100">
              <div class="d-flex align-items-center mt-4 rounded">
                <img src="${profile.avatar}" class="rounded me-2" style="width: 100px; height: 100px; object-fit: cover;">
